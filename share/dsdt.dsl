...
DefinitionBlock ("", "DSDT", 1, "BOCHS ", "BXPC    ", 0x00000001)
{
    ...
    Scope (_SB)
    {
        ...
        {
            Name (PRR0, Buffer (0x0B)
            {
                /* 0000 */  0x89, 0x06, 0x00, 0x09, 0x01, 0x00, 0x00, 0x00,  // ........
        ...
        Device (LNKA)
        {
            ...
            Name (_UID, Zero)  // _UID: Unique ID
            Name (_PRS, Buffer (0x13)  // _PRS: Possible Resource Settings
            {
                /* 0000 */  0x89, 0x0E, 0x00, 0x09, 0x03, 0x05, 0x00, 0x00,  // ........
                /* 0008 */  0x00, 0x0A, 0x00, 0x00, 0x00, 0x0B, 0x00, 0x00,  // ........
                /* 0010 */  0x00, 0x79, 0x00                                 // .y.
            })
        ...
        Device (LNKS)
        {
            ...
            Name (_PRS, Buffer (0x0B)  // _PRS: Possible Resource Settings
            {
                /* 0000 */  0x89, 0x06, 0x00, 0x09, 0x01, 0x09, 0x00, 0x00,  // ........
                /* 0008 */  0x00, 0x79, 0x00                                 // .y.
            })
            Method (_STA, 0, NotSerialized)  // _STA: Status
            {
    ...
    Scope (_SB)
    {
        Device (HPET)
        {
            ...
            {
                /* 0000 */  0x86, 0x09, 0x00, 0x00, 0x00, 0x00, 0xD0, 0xFE,  // ........
    ...
    Scope (_SB)
    {
        Device (\_SB.PCI0.PRES)
        {
            ...
            {
                /* 0000 */  0x47, 0x01, 0x00, 0xAF, 0x00, 0xAF, 0x01, 0x0C,  // G.......
                /* 0008 */  0x79, 0x00                                       // y.
            })
    ...
    Scope (\_SB.PCI0)
    {
        Name (_CRS, Buffer (0x9C)  // _CRS: Current Resource Settings
        {
            ...
            /* 0020 */  0x00, 0x00, 0xF7, 0x0C, 0x00, 0x00, 0xF8, 0x0C,  // ........
            /* 0028 */  0x88, 0x0D, 0x00, 0x01, 0x0C, 0x03, 0x00, 0x00,  // ........
            /* 0030 */  0x00, 0x0D, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0xF3,  // ........
            /* 0038 */  0x87, 0x17, 0x00, 0x00, 0x0C, 0x03, 0x00, 0x00,  // ........
            /* 0040 */  0x00, 0x00, 0x00, 0x00, 0x0A, 0x00, 0xFF, 0xFF,  // ........
            /* 0048 */  0x0B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
            /* 0050 */  0x02, 0x00, 0x87, 0x17, 0x00, 0x00, 0x0C, 0x01,  // ........
            /* 0058 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40,  // .......@
            /* 0060 */  0xFF, 0xFF, 0xBF, 0xFE, 0x00, 0x00, 0x00, 0x00,  // ........
            /* 0068 */  0x00, 0x00, 0xC0, 0xBE, 0x8A, 0x2B, 0x00, 0x00,  // .....+..
            /* 0070 */  0x0C, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
            /* 0078 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00,  // ........
            /* 0080 */  0x00, 0x00, 0xFF, 0xFF, 0xFF, 0x7F, 0x01, 0x00,  // ........
            /* 0088 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
            /* 0090 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00,  // ........
            /* 0098 */  0x00, 0x00, 0x79, 0x00                           // ..y.
        })
        Device (GPE0)
        {
            ...
            Name (_CRS, Buffer (0x0A)  // _CRS: Current Resource Settings
            {
                /* 0000 */  0x47, 0x01, 0xE0, 0xAF, 0xE0, 0xAF, 0x01, 0x04,  // G.......
                /* 0008 */  0x79, 0x00                                       // y.
            })
        }
        ...
        Device (PHPR)
        {
            ...
            Name (_CRS, Buffer (0x0A)  // _CRS: Current Resource Settings
            {
                /* 0000 */  0x47, 0x01, 0x00, 0xAE, 0x00, 0xAE, 0x01, 0x18,  // G.......
                /* 0008 */  0x79, 0x00                                       // y.
            })
        }
    }
    ...
    Scope (\_SB.PCI0)
    {
        Device (FWCF)
        {
            ...
            Name (_CRS, Buffer (0x0A)  // _CRS: Current Resource Settings
            {
                /* 0000 */  0x47, 0x01, 0x10, 0x05, 0x10, 0x05, 0x01, 0x0C,  // G.......
                /* 0008 */  0x79, 0x00                                       // y.
            })
        }
    }
        ...
        Scope (PCI0)
        {
            ...
            Device (S08)
            {
                ...
                Device (MOU)
                {
                    ...
                    Name (_STA, 0x0F)  // _STA: Status
                    Name (_CRS, Buffer (0x05)  // _CRS: Current Resource Settings
                    {
                ...
                Device (FDC0)
                {
                    ...
                    Name (_CRS, Buffer (0x18)  // _CRS: Current Resource Settings
                    {
                        /* 0000 */  0x47, 0x01, 0xF2, 0x03, 0xF2, 0x03, 0x00, 0x04,  // G.......
                        /* 0008 */  0x47, 0x01, 0xF7, 0x03, 0xF7, 0x03, 0x00, 0x01,  // G.......
                        /* 0010 */  0x22, 0x40, 0x00, 0x2A, 0x04, 0x00, 0x79, 0x00   // "@.*..y.
                    })
                    Device (FLPA)
                    {
                        Name (_ADR, Zero)  // _ADR: Address
                ...
                Device (LPT1)
                {
                    ...
                    {
                        /* 0000 */  0x47, 0x01, 0x78, 0x03, 0x78, 0x03, 0x08, 0x08,  // G.x.x...
                        /* 0008 */  0x22, 0x80, 0x00, 0x79, 0x00                     // "..y.
                    })
                }
                ...
                Device (COM1)
                {
                    ...
                    Name (_CRS, Buffer (0x0D)  // _CRS: Current Resource Settings
                    {
                        /* 0000 */  0x47, 0x01, 0xF8, 0x03, 0xF8, 0x03, 0x00, 0x08,  // G.......
